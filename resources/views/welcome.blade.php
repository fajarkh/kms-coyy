                                ...
                                <div class="section_content">
                                    <div class="grid clearfix">
                                        ...
                                        <div class="card card_large_with_background grid-item">
                                            <div class="card_background"
                                                style="background-image:url({{ asset('avision/images/post_8.jpg') }})"></div>
                                            <div class="card-body">
                                                <div class="card-title"><a href="#">How Did van Gogh’s
                                                        Turbulent Mind Depict One of the Most Complex Concepts in
                                                        Physics?</a></div>
                                        ...
                                        <div class="card grid-item card_large_with_image">
                                            <img class="card-img-top" src="{{ asset('avision/images/post_9.jpg') }}" alt="">
                                            <div class="card-body">
                                                <div class="card-title"><a href="#">How Did van Gogh’s
                                                        Turbulent Mind Depict One of the Most Complex Concepts in
                                                        Physics?</a></div>
                                        ...
                                        <div class="card card_small_with_image grid-item">
                                            <img class="card-img-top" src="{{ asset('avision/images/post_5.jpg') }}" alt="">
                                            <div class="card-body">
                                                <div class="card-title card-title-small"><a href="#">How Did
                                                        van Gogh’s Turbulent Mind Depict One of the Most Complex
                                                        Concepts in Physics?</a></div>
                                        ...
                                        <div class="card card_default card_default_with_background grid-item">
                                            <div class="card_background"
                                                style="background-image:url({{ asset('avision/images/post_6.jpg') }})"></div>
                                            <div class="card-body">
                                                <div class="card-title card-title-small"><a href="#">How Did
                                                        van Gogh’s Turbulent Mind Depict One of the Most</a></div>
                                            </div>
                                        ...
                                        <div class="card card_default card_default_with_background grid-item">
                                            <div class="card_background"
                                                style="background-image:url({{ asset('avision/images/post_7.jpg') }})"></div>
                                            <div class="card-body">
                                                <div class="card-title card-title-small"><a href="#">How Did
                                                        van Gogh’s Turbulent Mind Depict One of the Most</a></div>
                                            </div>
                                                ...
                                                <div class="playlist">
                                                    ...
                                                    <div class="video_container video_command active"
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="video_image">
                                                                <div><img src="{{ asset('avision/images/video_1.jpg') }}" alt=""></div><img
                                                                    class="play_img" src="{{ asset('avision/images/play.png') }}"
                                                                    alt="">
                                                            </div>
                                                    ...
                                                    <div class="video_container video_command"
                                                        ...
                                                        <div
                                                            class="video d-flex flex-row align-items-center justify-content-start">
                                                            <div class="video_image">
                                                                <div><img src="{{ asset('avision/images/video_2.jpg') }}" alt=""></div><img
                                                                    class="play_img" src="{{ asset('avision/images/play.png') }}"
                                                                    alt="">
                                                            </div>
                                                            <div class="video_content">
                                                    ...
                                                    <div class="video_container video_command"
                                                        ...
                                                        <div
                                                            class="video d-flex flex-row align-items-center justify-content-start">
                                                            <div class="video_image">
                                                                <div><img src="{{ asset('avision/images/video_3.jpg') }}" alt=""></div><img
                                                                    class="play_img" src="{{ asset('avision/images/play.png') }}"
                                                                    alt="">
                                                            </div>
                                                            <div class="video_content">
                                                    ...
                                                    <div class="video_container video_command"
                                                        ...
                                                        <div
                                                            class="video d-flex flex-row align-items-center justify-content-start">
                                                            <div class="video_image">
                                                                <div><img src="{{ asset('avision/images/video_4.jpg') }}" alt=""></div><img
                                                                    class="play_img" src="{{ asset('avision/images/play.png') }}"
                                                                    alt="">
                                                            </div>
                                                            <div class="video_content">
                            ...
                            <div class="blog_section">
                                ...
                                <div class="section_content">
                                    <div class="grid clearfix">
                                        ...
                                        <!-- Small Card With Image -->
                                        <div class="card card_small_with_image grid-item">
                                            <img class="card-img-top" src="{{ asset('avision/images/post_10.jpg') }}" alt="">
                                            <div class="card-body">
                                                <div class="card-title card-title-small"><a href="#">How Did
                                                        van Gogh’s Turbulent Mind Depict One of the Most Complex
                                                        Concepts in Physics?</a></div>
                                        ...
                                        <!-- Small Card With Image -->
                                        <div class="card card_small_with_image grid-item">
                                            <img class="card-img-top" src="{{ asset('avision/images/post_15.jpg') }}" alt="">
                                            <div class="card-body">
                                                <div class="card-title card-title-small"><a href="#">How Did
                                                        van Gogh’s Turbulent Mind Depict One of the Most Complex
                                                        Concepts in Physics?</a></div>
                                        ...
                                        <div class="card card_default card_small_with_background grid-item">
                                            <div class="card_background"
                                                style="background-image:url({{ asset('avision/images/post_11.jpg') }})"></div>
                                            <div class="card-body">
                                                <div class="card-title card-title-small"><a href="#">How Did
                                                        van Gogh’s Turbulent Mind Depict One of the Most Complex
                                                        Concepts in Physics?</a></div>
                                        ...
                                        <div class="card card_default card_small_with_background grid-item">
                                            <div class="card_background"
                                                style="background-image:url({{ asset('avision/images/post_16.jpg') }})"></div>
                                            <div class="card-body">
                                                <div class="card-title card-title-small"><a href="#">How Did
                                                        van Gogh’s Turbulent Mind Depict One of the Most Complex
                                                        Concepts in Physics?</a></div>
                                        ...
                                        <!-- Small Card With Image -->
                                        <div class="card card_small_with_image grid-item">
                                            <img class="card-img-top" src="{{ asset('avision/images/post_14.jpg') }}" alt="">
                                            <div class="card-body">
                                                <div class="card-title card-title-small"><a href="#">How Did
                                                        van Gogh’s Turbulent Mind Depict One of the Most Complex
                                                        Concepts in Physics?</a></div>
                                        ...
                                        <div class="card card_default card_default_with_background grid-item">
                                            <div class="card_background"
                                                style="background-image:url({{ asset('avision/images/post_12.jpg') }})"></div>
                                            <div class="card-body">
                                                <div class="card-title card-title-small"><a href="#">How Did
                                                        van Gogh’s Turbulent Mind Depict One of the Most</a></div>
                                            </div>
                        ...
                        <div class="sidebar">
                            ...
                            <div class="sidebar_section">
                                <div class="sidebar_title_container">
                                    <div class="sidebar_title">Cerita Terbaru</div>
                                                    ...
                                                    <a href="#">
                                                        <div
                                                            ...
                                                            <div class="side_post_image">
                                                                <div><img src="{{ asset('avision/images/top_1.jpg') }}" alt=""></div>
                                                            </div>
                                                ...
                                                <div class="side_post">
                                                    <a href="#">
                                                        <div
                                                            class="d-flex flex-row align-items-xl-center align-items-start justify-content-start">
                                                            <div class="side_post_image">
                                                                <div><img src="{{ asset('avision/images/top_2.jpg') }}" alt=""></div>
                                                            </div>
                                                            <div class="side_post_content">
                                                                <div class="side_post_title">How Did van Gogh’s
                                                                    Turbulent Mind</div>
                                                ...
                                                <div class="side_post">
                                                    <a href="#">
                                                        <div
                                                            class="d-flex flex-row align-items-xl-center align-items-start justify-content-start">
                                                            <div class="side_post_image">
                                                                <div><img src="{{ asset('avision/images/top_3.jpg') }}" alt=""></div>
                                                            </div>
                                                            <div class="side_post_content">
                                                                <div class="side_post_title">How Did van Gogh’s
                                                                    Turbulent Mind</div>
                                                ...
                                                <div class="side_post">
                                                    <a href="#">
                                                        <div
                                                            class="d-flex flex-row align-items-xl-center align-items-start justify-content-start">
                                                            <div class="side_post_image">
                                                                <div><img src="{{ asset('avision/images/top_4.jpg') }}" alt=""></div>
                                                            </div>
                                                            <div class="side_post_content">
                                                                <div class="side_post_title">How Did van Gogh’s
                                                                    Turbulent Mind</div>
                                                ...
                                                <div class="side_post">
                                                    <a href="#">
                                                        <div
                                                            class="d-flex flex-row align-items-xl-center align-items-start justify-content-start">
                                                            <div class="side_post_image">
                                                                <div><img src="{{ asset('avision/images/vid_1.jpg') }}" alt=""></div>
                                                            </div>
                                                            <div class="side_post_content">
                                                                <div class="side_post_title">How Did van Gogh’s
                                                                    Turbulent Mind</div>
                                                ...
                                                <div class="side_post">
                                                    <a href="#">
                                                        <div
                                                            class="d-flex flex-row align-items-xl-center align-items-start justify-content-start">
                                                            <div class="side_post_image">
                                                                <div><img src="{{ asset('avision/images/vid_2.jpg') }}" alt=""></div>
                                                            </div>
                                                            <div class="side_post_content">
                                                                <div class="side_post_title">How Did van Gogh’s
                                                                    Turbulent Mind</div>
                                                ...
                                                <div class="side_post">
                                                    <a href="#">
                                                        <div
                                                            class="d-flex flex-row align-items-xl-center align-items-start justify-content-start">
                                                            <div class="side_post_image">
                                                                <div><img src="{{ asset('avision/images/vid_3.jpg') }}" alt=""></div>
                                                            </div>
                                                            <div class="side_post_content">
                                                                <div class="side_post_title">How Did van Gogh’s
                                                                    Turbulent Mind</div>
                                                ...
                                                <div class="side_post">
                                                    <a href="#">
                                                        <div
                                                            class="d-flex flex-row align-items-xl-center align-items-start justify-content-start">
                                                            <div class="side_post_image">
                                                                <div><img src="{{ asset('avision/images/vid_4.jpg') }}" alt=""></div>
                                                            </div>
                                                            <div class="side_post_content">
                                                                <div class="side_post_title">How Did van Gogh’s
                                                                    Turbulent Mind</div>
