...
class AdatPernikahanDataTable extends DataTable
{
    private $route = 'adatpernikahan';
    ...
    public function query(AdatPernikahan $model)
    {
    ...
    public function html()
    {
        $builder = $this->builder()
            ->setTableId('tabelAdatPernikahan')
    ...
    {
        return 'AdatPernikahan_' . date('YmdHis');
    }
}
